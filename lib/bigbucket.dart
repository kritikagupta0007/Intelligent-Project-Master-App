...
class BigBucket extends StatefulWidget {
  @override
  _BigBucketState createState() => _BigBucketState();
}

class _BigBucketState extends State<BigBucket> {
          ...
          child: Column(
            children: <Widget>[
              Container(
                  ...
                  child: Image.asset('assets/bitbucket.jpg',
                      height: 200,
                      width: 300,
